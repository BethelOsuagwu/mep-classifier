...
fnames=[None];
fnames[0]=os.path.join('./data/H2_s1_session1_both_c3-c4_relax_s1_smep-recruitment-c3-c4_labelled.csv');


# Load data
data,targets=loadResponseData(fnames);

data,targets=discardExcessBackgroundData(data,targets,discard_percent=5);

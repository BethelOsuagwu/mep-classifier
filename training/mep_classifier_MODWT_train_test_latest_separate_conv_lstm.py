...
# In this experiment the conv and lstm are connected in parallel.
...
if using_causal_data:
    ...
    test_data,test_targets = sequence_generator(eva_data,eva_targets,sequence_len,0);
else:
    ...
    test_data,test_targets = sequence_generator_non_causal(eva_data,eva_targets,sequence_len);
...
model=getFunctionalModel(num_classes,bg_mean,bg_std);
